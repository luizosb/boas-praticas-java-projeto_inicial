...
public class PetService {
    ...
    public void importarPets() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            HttpResponse<String> response = client.postResponse(uri, pet);
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        String responseBody = response.body();
        var pets = new ObjectMapper().reader().readValue(responseBody, Pet[].class);
        var listPets = Arrays.stream(pets).toList();
